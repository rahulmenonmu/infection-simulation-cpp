...
public:
    ...
    int run(bool charwait = false)
    {
        ...
        //cout<<"Total number of steps : "<< simCount <<"\t"<<"Fatalities : "<<map->f_count<<endl;
        return map->f_count;
    }
};
...
int main(int argc, const char *argv[])
{
    ...
    // Map map(13, 17);
    // Simulation sim(&map, 13, 17, 95, 5, 0, 0.5, 0.1, 0.05, 100); // Simulation(Map * _map, int _y, int _x, int _healthy, int _infected, int _blocks, float _ir, float _rr, float _mr, float _mp)
    // sim.run();

    float avg;
    // Part i and ii
    srand((unsigned int)time(NULL)*0.1);
    avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.5, 0.1, 0.05, 5);
    cout<<endl<<"Average Fatalities for case a with MP = 5 : "<<avg<<endl;

    srand((unsigned int)time(NULL)*1000);

    avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.5, 0.1, 0.05, 100);
    cout<<endl<<"Average Fatalities for case b with MP = 100 : "<<avg<<endl;

    srand((unsigned int)time(NULL)*1000000);

    avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.5, 0.1, 0.05, 8);
    cout<<endl<<"Average Fatalities for case c with MP = 8 : "<<avg<<endl;


    //Part iii
    //MP = 5
    // for(int i = 0 ; i < 10; ++i){
    //     srand((unsigned int)time(NULL)*0.1*(i+1));
    //     avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.1 * ( i + 1 ), 0.1, 0.05, 5);
    //     cout<<endl<<"Average Fatalities for case a with MP = 5 and IR = "<<0.1 * ( i + 1 )<<" : "<< avg <<endl;
    // }
    ...
    // for(int i = 0 ; i < 10; ++i){
    //     srand((unsigned int)time(NULL)*0.1*(i+1));
    //     avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.1 * ( i + 1 ), 0.1, 0.05, 100);
    //     cout<<endl<<"Average Fatalities for case a with MP = 100 and IR = "<<0.1 * ( i + 1 )<<" : "<< avg <<endl;
    // }
    ...
    // for(int i = 0 ; i < 10; ++i){
    //     srand((unsigned int)time(NULL)*0.1*(i+1));
    //     avg = runSimulation(1000 ,13, 17, 95, 5, 0, 0.1 * ( i + 1 ), 0.1, 0.05, 8);
    //     cout<<endl<<"Average Fatalities for case a with MP = 8 and IR = "<<0.1 * ( i + 1 )<<" : "<< avg <<endl;
    // }
