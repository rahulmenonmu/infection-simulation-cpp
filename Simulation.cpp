...
//     location* pop(){
//         if(length > 0){
//             location *ret = locs[length];
//             delete locs[length--];
//             return ret;
//         }
//     }
//     void display(){
//         cout<<"Locations in the list are :"<<endl;
//         for (int i = 0; i < length; ++i){
...
void Map::moveCharacters()
{
    for (node *n = characters.top; n != NULL; n = n->next)
    {
        ...
        default:
            ...
            //cout<<"Stay prob : " << stayProbability<<endl;;
...
int main(int argc, const char *argv[])
{
    ...
    Map map(13, 17);
    Simulation sim(&map, 13, 17, 95, 5, 12, 0.5, 0.1, 0.05, 5); // Simulation(Map * _map, int _y, int _x, int _healthy, int _infected, int _blocks, float _ir, float _rr, float _mr, float _mp)
    sim.run();
    return 0;
}